...
class Kb:
  ...
  def __init__(self):
    ...
    # 1. Sicilian Defense
    prolog.assertz("play('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1', c7c5)")

    # 2. French Defense
    prolog.assertz("play('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1', e7e6)")

    # 3. Ruy López
    prolog.assertz("play('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1', e7e5)")
    prolog.assertz("play('rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2', g1f3)")
    ...
    # 4. Caro-Kann Defense
    prolog.assertz("play('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1', c7c6)")
    ...
    prolog.assertz("play('rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq c6 0 2', b1c3)")

    # -> d4 openings:

    # 1. Queen's Gambit
    prolog.assertz("play('rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1', d7d5)")
    prolog.assertz("play('rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq d6 0 2', c2c4)")

    # 2. Slav Defense
    # Same first 3 moves as in Queen's Gambit
    prolog.assertz("play('rnbqkbnr/ppp1pppp/8/3p4/2PP4/8/PP2PPPP/RNBQKBNR b KQkq c3 0 2', c7c6)")

    # 3. King's Indian Defense
    prolog.assertz("play('rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1', g8f6)")
    prolog.assertz("play('rnbqkb1r/pppppppp/5n2/8/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 1 2', c2c4)")
    prolog.assertz("play('rnbqkb1r/pppppppp/5n2/8/2PP4/8/PP2PPPP/RNBQKBNR b KQkq c3 0 2', g7g6)")
    
    # 4. Nimzo-Indian Defense
    # Same first 3 moves as in King's Indian Defense
    prolog.assertz("play('rnbqkb1r/pppppppp/5n2/8/2PP4/8/PP2PPPP/RNBQKBNR b KQkq c3 0 2', e7e6)")
